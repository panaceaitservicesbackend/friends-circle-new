# Unified Balance API – Testing Guide
...
- Determines user type by checking if URL contains `/female-user`
...
- Determines user type by checking if URL contains `/agency`
...
### 11.1 Female User
- Route: `GET /female-user/me/balance`
- Controller: `withdrawalController.getMyBalance`
- Middleware: `auth`, `requireReviewAccepted`

### 11.2 Agency User
- Route: `GET /agency/me/balance`  
- Controller: `withdrawalController.getMyBalance`
- Middleware: `auth`, `requireReviewAccepted`

### 11.3 Common Logic
- Same controller function handles both user types
- User type determined by URL pattern matching
- Consistent response format for both types